/* =====================================================================
   Minsheng Elementary — shared motion engine  (motion.js)
...
(function(){
  ...
  ready(function(){
    ...
    var hero=document.querySelector('.title,.page-banner,.banner,.th-fest-hero,.unit-hero');
    if(hero){
      ...
      [
        {s:280,t:'-8%', l:'-5%', c:'rgba(184,149,74,.55)', dx:'36px',  dy:'30px',  d:17},
        {s:210,t:'34%', l:'80%', c:'rgba(123,30,30,.50)',  dx:'-42px', dy:'24px',  d:21},
        {s:150,t:'66%', l:'16%', c:'rgba(245,230,196,.55)',dx:'28px',  dy:'-32px', d:14}
      ].forEach(function(o){
